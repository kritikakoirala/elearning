<?php include './includes/header.php'; 
  ...
  if(isset($_POST['teachersignUp'])){
    ...
    furtherValidation(($_POST['firstName']), ($_POST['middleName']), ($_POST['lastName']), ($_POST['username']), ($_POST['email']), ($_POST['password']), ($_POST['confirmPassword']), ($gender));
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-0">
          <div class="signupSidebar" data-aos='fade-left' data-aos-delay="100">
            <h2 class="text-capitalize mb-4" >Sign up with us</h2>
            <img src="./images/teacher_signup1.svg" alt="teacher">
            <p class="font-weight-bold mt-5"><i class="fas fa-plus-circle"></i>  Start a new Course</p>
            <p class="font-weight-bold"><i class="fas fa-bullhorn"></i>  Share your knowledge</p>
          </div>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12" data-aos='fade-right' data-aos-delay="100">
          ...
          <form method='POST' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="pb-4">
            ...
            <input type="submit" class="btn signUpBtn" name='teachersignUp' value='Sign Up'>
          </form>
