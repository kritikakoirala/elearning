    ...
    <div class="container mt-4">
        <div class="row col-lg-12 col-md-12 col-sm-12">
          <table id ='dataTable' class="table table-bordered mt-4">
            ...
            <tbody>
              <?php
                $getTutor= $mysqli->query("select * from tutor, user where tutor.User_id = user.User_id");
                
                $getTutorResult = $getTutor->fetch_all(MYSQLI_ASSOC);
                if($getTutor->num_rows>0){
                  foreach($getTutorResult as $row){
                    ?>
                      <tr>
                        <td><?php
